...
from src.soc_engine import run_soc_engine
...
def main() -> None:
    ...
    print("Step 2 — Running SoC engine …")
    df = run_soc_engine(df, battery)

    print("Step 3 — Running revenue engine …")
    df = run_revenue_engine(df, battery, market)

    print("Step 4 — Building summary …")
